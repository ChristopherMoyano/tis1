            ...
            <div class="col">
                <form action="editar_datos.php" method="POST">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="nombre" class="form-control" value="<?php echo $nombre ?>" placeholder="Peugeot">
                    </div>
                    <div class="input-group mb-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="logo" class="form-control" value = "<?php echo $logo ?>" placeholder="../logo.peugeot.jpg">
                    </div>
